...
const baseFunnel: FunnelStage[] = [
  ...
  ["first-route", "完成首条路线", 895, 71.7, "筛选时间内首次完成任意有效路线", "筛选时间内首次完成 1 条 MOVEVI 有效路线的去重用户数量，路线需完整完成。"],
...
const metricDefinitions: Record<string, string> = {
  ...
  "运动里程": "当前筛选周期内全部有效运动记录的里程合计，单次需不少于 1 公里且不少于 8 分钟。",
  "运动时长": "当前筛选周期内全部有效运动记录的运动时长合计，剔除异常中断与无设备数据。",
  "已上线城市": "MOVEVI App 内至少有 1 条已发布且可开始路线的城市数。",
  "有效路线": "已通过内容审核且近 90 日至少被启动 1 次的 MOVEVI App 路线数。",
  "已上线路线": "已完成内容审核并正式上线的 MOVEVI App 路线数。",
...
const modules: Record<string, ModuleData> = {
  ...
  users: {
    ...
    trend: [
      { date: "8日", value: 602, secondary: 286 },
      { date: "11日", value: 668, secondary: 348 },
      { date: "14日", value: 734, secondary: 414 },
      { date: "17日", value: 700, secondary: 368 },
      { date: "20日", value: 801, secondary: 426 },
      { date: "23日", value: 768, secondary: 484 },
      { date: "26日", value: 868, secondary: 518 },
      { date: "29日", value: 902, secondary: 612 },
      { date: "32日", value: 968, secondary: 724 },
    ], chartTitle: "新增用户与活跃用户趋势", chartUnit: "人",
  ...
  content: {
    ...
    metrics: [metric("cities", "已上线城市", "86", 86, "+8", "点击查看六大洲城市列表"), metric("routes", "已上线路线", "1,248", 1248, "+6.4%", "点击搜索全部已上线路线"), metric("spots", "城市景点数", "6,842", 6842, "+5.8%", "路线内可识别景点"), metric("completion", "路线完播率", "71.8%", 71.8, "+2.6pp", "完整播放并完成路线")],
    trend: [
      { date: "8日", value: 6820, secondary: 61 },
      { date: "11日", value: 7240, secondary: 64 },
      { date: "14日", value: 7080, secondary: 63 },
      { date: "17日", value: 7860, secondary: 68 },
      { date: "20日", value: 8240, secondary: 70 },
      { date: "23日", value: 8160, secondary: 69 },
      { date: "26日", value: 8920, secondary: 73 },
      { date: "29日", value: 9340, secondary: 75 },
